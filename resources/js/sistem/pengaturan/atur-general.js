...
if (btPilihLogo && BOLEHEDIT) btPilihLogo.addEventListener('click', eventFoto)
if (btUbahLogo && BOLEHEDIT) btUbahLogo.addEventListener('click', eventFoto)
