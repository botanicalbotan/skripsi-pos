...
btSubmit.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    text: `Anda akan menyimpan pengajuan gadai sebesar ${rupiahParser(nominalGadai)} oleh ${capsFirstWord(namaPenggadai.value)} dengan tenggat waktu tanggal ${new Date(tanggalTenggat.value).toLocaleDateString('id-ID', { month: 'long', day: 'numeric', year: 'numeric' })}. Lanjutkan?`,
    icon: 'question',
