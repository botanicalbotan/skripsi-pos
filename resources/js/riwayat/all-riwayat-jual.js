...
//   fkTersedia.addEventListener('click', function () {
//     updateKeyQs('fk', 1)
//     persiapanKirim()
//   })

//   fkHampir.addEventListener('click', function () {
//     updateKeyQs('fk', 2)
//     persiapanKirim()
//   })

//   fkHabis.addEventListener('click', function () {
//     updateKeyQs('fk', 3)
//     persiapanKirim()
//   })
  ...
  btAturTabel.addEventListener('click', (e) => {
    Swal.fire({
        ...
        willOpen: () => {
          ...
          $.get("/app/cumaData/kadarSimpel", {},
              function (data, textStatus, jqXHR) {
                 data.forEach(element => {
                    let opt = document.createElement('option')
                    opt.value = element.nama
